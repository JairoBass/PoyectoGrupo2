...
<html lang="en">
  <head>
    ...
    <title> RESTAURANT EL ALABADO & GRILL</title>
<!-- Bootstrap -->
...
<link href="css/style.css" rel="stylesheet" />	  
  ...
  <body>	
		...
		<div id="about-slider">
			<div id="carousel-slider" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
				    ...
				    <div class="item">
						<img src="img/0.jpg" class="img-responsive" alt=""> 
				    </div> 
				</div>
	...
	<div class="about">
		<div class="container">
			<div class="text-center">
				<h2> En la actualidad existe una gran cantidad de restaurantes diferentes, que ofrecen distintos servicios y especialidades. De acuerdo al tipo de cocina que sirven,
					somos tu mejor opción al momento de compartir en familia, será un gusto atenderles. 
				</h2>
			</div>	
		</div>			
	</div>
	...
	<div class="services">
		<div class="container">
			...
			<div class="col-md-3 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="900ms">
				...
				<h3>Agenda tus platos favoritos</h3>
				<p> Anganda nuestros mejores platos tradicionales del cantón Latacunga a un precio super económico.</p>
			</div>
	...
	<section class="action">
		<div class="container">
			<div class="left-text hidden-xs">
				...
				<p><em>El Alabado Grill, es un restaurante sumamente reconocido en el cantón Latacunga, ofrece a la clientela los mejores combos, platos tradicionales del cantón
					 ven y disfruta de nuestra gastronomía, será un gusto servirle, atencion de martes a domingo de 12h00 a 22h00.
				</div>
	...
	<div class="gallery">
		<div class="text-center">
			<h2>Galería</h2>
			<p>Galeria de nuestras promociones especiales en fechas importantes, ofrecemos pedidos a domicilio sin recargo alguno.<br> Disfrute de los mejores platos, será un placer servirle..!! </p>
		</div>
		<div class="container">		
			<div class="col-md-4">
				<figure class="effect-marley">
					<img src="img/combo1.jpg" alt="" class="img-responsive"/>
					<figcaption>
						<h4>Miercoles 2x$10  <br></bR>  PECHITO DE CERDO BBQ</h4>
						<p> </p>				
					</figcaption>			
				</figure>
			</div>
			<div class="col-md-4">
				<figure class="effect-marley">
					...
					<figcaption>
						<h4>JUEVES 2x$10  <br></bR> MILANESA A LA NAPOLITANA </h4>
						<p> </p>				
					</figcaption>			
				</figure>
			</div>
			<div class="col-md-4">
				<figure class="effect-marley">
					<img src="img/combo3.jpg" alt="" class="img-responsive"/>
					<figcaption>
						<h4>VIERNES 2x$10  <br></bR> PECHUGA DE POLLO </h4>
						<p> </p>				
					</figcaption>			
				</figure>
			</div>
		...
		<div class="container">
			<div class="col-md-4">
				<figure class="effect-marley">
					...
					<figcaption>
						<h4>MARTES 2x1  <br></bR> ojo de costilla </h4>
						<p> </p>				
					</figcaption>			
				</figure>
			</div>
			<div class="col-md-4">
				<figure class="effect-marley">
					...
					<figcaption>
						<h4>Miercoles de amigos   <br></bR> Alitas en salsa dulce</h4>
						<p> </p>				
					</figcaption>			
				</figure>
			</div>
			<div class="col-md-4">
				<figure class="effect-marley">
					...
					<figcaption>
						<h4>Viernes 2x$20 <br></bR> POLLO A LA PARILLA </h4>
						<p> .</p>				
					</figcaption>			
				</figure>
			</div>
		...
		<div class="container">
			<div class="col-md-4 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
				...
				<div class="contact-info">
					<ul>
						<li><i class="fa fa-home fa"></i>Quijano y Ordoñez, C. Gral. Maldonado &, Latacunga </li>
						<li><i class="fa fa-phone fa"></i> +593 983326478</li>
						<li><i class="fa fa-envelope fa"></i> elalabado&grill2021@gmail.com</li>
					</ul>
				</div>
			</div>
